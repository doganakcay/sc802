...
'       translate(T.PERSONEL_ADI || '' '' || T.SOYADI, ''ÝÖÜÇÐÞ'', ''IOUCGS'') AD,' + #13#10 +
'       SUBSTR(T.TC_KIMLIK_NO, -4) Sýfre,' + #13#10 +
...
begin
label1.Caption:='Baðlantý Saðlandý';
end;
